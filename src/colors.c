...
static ColorPairs color_scheme[] = {
    ...
    // Entry icon
    {THEME_DIR_ICON, COLOR_FG_BLUE, COLOR_DEFAULT, 0},
    {THEME_FILE_ICON, COLOR_DEFAULT, COLOR_DEFAULT, 0},
    {THEME_C_ICON, COLOR_FG_BLUE, COLOR_DEFAULT, 0},
    {THEME_PYTHON_ICON, COLOR_FG_YELLOW, COLOR_DEFAULT, 0},
